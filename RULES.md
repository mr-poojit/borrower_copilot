...
Most knobs the engine uses live in `src/rules/constants.ts`; product bounds live in `src/rules/products.ts` and routing gates in `src/rules/assess.ts`. Change a number there in the follow-up; the UI only prints what the engine returns.
...
| O2 Two amounts                  | **Lender likely sanction** = FOIR on _lender income_ (ITR for self-employed; cash ignored), capped by product max and LTV. **Safe carry** = min(safe FOIR on _borrower cash income_, leftover after expenses and a residual floor), same LTV cap. Recommended ask = min(requested, safe, lender). |
...
| Product            | Minimum / maximum amount  | Why                                                                                | Source or judgement        |
| :----------------- | :------------------------ | :--------------------------------------------------------------------------------- | :------------------------- |
| Personal           | ₹50,000 / ₹40,00,000      | Keeps a personal-loan estimate inside a typical retail product range.              | My judgement.              |
| LAP                | ₹5,00,000 / ₹5,00,00,000  | Secured business/property lending supports larger principals than personal credit. | My judgement.              |
| Unsecured business | ₹1,00,000 / ₹50,00,000    | Working-capital product range for an unsecured MSME estimate.                      | My judgement.              |
| Two-wheeler        | ₹30,000 / ₹3,50,000       | Matches a scooter/two-wheeler ticket size.                                         | OEM/NBFC product practice. |
| Gold               | ₹10,000 / ₹50,00,000      | Short secured bridge range; actual lender limits vary by purity and branch.        | My judgement.              |
| Home               | ₹5,00,000 / ₹10,00,00,000 | Keeps the estimate inside a standard retail home-loan range.                       | My judgement.              |

### Product-routing gates

| Gate                        | Value                                                                    | Why                                                                    | Source or judgement |
| :-------------------------- | :----------------------------------------------------------------------- | :--------------------------------------------------------------------- | :------------------ |
| Vehicle route               | Vehicle purpose or two-wheeler request, and requested amount ≤ ₹3,50,000 | A scooter-sized request can be matched to secured vehicle credit.      | My judgement.       |
| Property considered for LAP | Stated property value ≥ ₹10,00,000                                       | Avoids presenting LAP for collateral too small to support the product. | My judgement.       |
| LAP capacity gate           | Property LTV capacity ≥ min(requested amount, ₹5,00,000)                 | Requires at least a plausible secured ticket before routing to LAP.    | My judgement.       |
...
Unknown credit **does not** get a second widening on top of the unknown table. Missing _other_ fields still widen **amount** bands (below).
...
Confidence starts at 80 and is reduced as follows. The deductions are a transparent completeness heuristic, not a probability of repayment.

| Condition                       | Value             | Why                                                                                       | Source or judgement |
| :------------------------------ | :---------------- | :---------------------------------------------------------------------------------------- | :------------------ |
| Starting score                  | 80                | A complete, internally consistent self-report starts above the high-confidence threshold. | My judgement.       |
| Credit score unknown            | −20               | Bureau information is a major missing input.                                              | My judgement.       |
| Household expenses unknown      | −10               | Safe carry can be materially overstated without living costs.                             | My judgement.       |
| Existing EMI unknown            | −12               | Debt-service headroom cannot be trusted without current EMIs.                             | My judgement.       |
| Self-employed ITR unknown       | −12               | Lender-view income cannot be reconstructed reliably.                                      | My judgement.       |
| Informal variable share unknown | −8                | Cash volatility is not quantified.                                                        | My judgement.       |
| Emergency savings unknown       | −5                | Buffer resilience is unclear.                                                             | My judgement.       |
| One or more missed payments     | −5                | Recent repayment stress lowers confidence in the self-report.                             | My judgement.       |
| Each unknown field              | −3, capped at −15 | Prevents many skipped fields from being treated as harmless.                              | My judgement.       |
